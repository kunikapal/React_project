...
function Field_investigation(){
    return (
        <>
            <section className='field_invest_section service_section'>
                        ...
                        <div className="col-lg-12">
                            <p className="service_para">
                                <b>
                                    ...
                                    • Field density (Bulk & Dry)<br/>
                                    • In-situ Vane Shear<br/>
                                    • Permeability Tests
                                </b>
                            </p>
                        </div>
...
export default Field_investigation;